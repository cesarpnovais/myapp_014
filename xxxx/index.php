                        ...
                        <tbody>
                            <?php
                                while($row = mysqli_fetch_array($result)) 
                                    { 
                                        $cod =  $row['cod'];
                                        $imagemPerfil = $row['imagemId'] . '.jpg';
                                        echo '<div class="col mb-5">';
                                        echo '    <div class="card h-100">';
                                        echo '      <div id=".circulo">';
                                        echo '        <img onclick="ativafuncao(this)" style="border-radius: 10px; width: 260x;  height: 270px"  id="'. $cod .'" class="card-img-top" src="detail/image/'. $imagemPerfil .'" alt="..." />';
                                        echo '      </div>';
                                        echo '    </div>';
                                        echo '</div>';
                                    }
...
//                }
                ...
                //alert("id da imagem "+ el.id)
                $instructionSqlWhere = " where cod = " + el.id ;
                window.open("detail/detail.php?f=''&c="+ el.id +"&i=" + $instructionSqlWhere, target="_self");                
            }
            function functionFiltrar() {
                ...
                window.open("index.php?f='detail'&i="+x ,target="_self");
                }
            </script>
    </body>
</html>
