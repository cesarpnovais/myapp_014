...
<html lang="pt-br">
    ...
    <div>
        <body>
            <!-- Section iFrameTitulo -->
            <section id="section_iFrameTitulo">
                <div style="align-items:left; margin-top: 5px;"><IFRAME name=gridTitulo src="tripPlanner_IframeTitulo.php" frameBorder=0 style="overflow: scroll; height: 27vh; width: 98.5vw; margin-left: 2px;" scrolling="false"  ></IFRAME></div>
            </section>
